        ...
        if form.is_valid():
            ...
            if source == 'Contact':
                ...
                try:
                    ...
                    from_email = settings.MAIL_SENDER
                    text_content = 'TEST BG RACE'
                    html_content_FR = "<u> English version below </u> <p>Bonjour,</p> <p>Une demande de renseignement a été formulée depuis le site internet ARCHAMBAULT BY BG RACE via votre page de distributeur officiel de nos bateaux. </p> <p>Voici le contenu de la demande : </p> <p><b>IDENTITÉ </b>:"+ request.POST['name'] +"</p> <p> <b>MAIL </b>: "+ request.POST['mail'] +"</p> <p><b>TEL</b> :"+ request.POST['phone'] +"</p> <p> <b>MESSAGE</b> : "+ request.POST['content'] +"</p> <p>Au cas où vous ne pourriez pas répondre à cette demande, nous vous prions de contacter : <br /> Louis Burton ou Servane Escoffier <br /> Mail : info@bgrace <br /> Tel: +33(0)2 23 15 14 92 </p> <p> Merci, <br /><h4>L'équipe Archambault by BG RACE</h4>"
