        ...
        if form.is_valid():
            ...
            if source == 'Contact':
                ...
                try:
                    ...
                    from_email = settings.MAIL_SENDER
                    text_content = 'TEST BG RACE'
                    html_content_FR = "<u> English version below </u> <p>Bonjour,</p> <p>Une demande de renseignement a été formulée depuis le site internet ARCHAMBAULT BY BG RACE via votre page de distributeur officiel de nos bateaux. </p> <p>Voici le contenu de la demande : </p> <p><b>IDENTITÉ </b>:"+ request.POST['name'] +"</p> <p> <b>MAIL </b>: "+ request.POST['mail'] +"</p> <p><b>TEL</b> :"+ request.POST['mail'] +"</p> <p> <b>MESSAGE</b> : "+ request.POST['content'] +"</p> <p>Au cas où vous ne pourriez pas répondre à cette demande, nous vous prions de contacter : <br /> Louis Burton ou Servane Escoffier <br /> Mail : info@bgrace <br /> Tel: +33(0)2 23 15 14 92 </p> <p> Merci, <br />L'équipe Archambault by BG RACE"
                    html_content_EN = "<p> <b>ENGLISH VERSION</b> </p><p>Dear Sir, Dear Madam, </p> <p> A customer has requested informations through your dedicated page on our Website. </p> <p> The following states the request : </p> <p> <b>NAME </b>:"+ request.POST['name'] +"</p> <p> <b>MAIL </b>: "+ request.POST['mail'] +"</p> <p><b>PHONE</b> : "+ request.POST['phone'] +"</p> <p> <b>MESSAGE</b> : "+ request.POST['content'] +" </p> <p>Should it be impossible for you to answer the aformentioned, please contact : </p> <p>Servane ESCOFFIER or Louis BURTON <br /> Mail: info@bgrace.fr <br /> Phone number: +33 (0)2 23 15 14 92 <br /> Thank you, <br /> Archambault by BG Race’s team </p>"
